  ...
  switch (platform) {
    case "FACEBOOK":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          <path
            d="M24 12C24 5.373 18.627 0 12 0S0 5.373 0 12c0 5.99 4.388 10.954 10.125 11.854V15.47H7.078V12h3.047V9.356c0-3.007 1.79-4.668 4.533-4.668 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.875V12h3.328l-.532 3.469h-2.796v8.385C19.612 22.954 24 17.99 24 12z"
            fill="#1877F2"
          />
        </svg>
      );
    case "INSTAGRAM":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          <defs>
            <radialGradient id="ig_tab_grad_inbox" cx="30%" cy="107%" r="150%">
          ...
          <rect width="24" height="24" rx="6" fill="url(#ig_tab_grad_inbox)" />
    ...
    case "WHATSAPP":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          ...
          />
          <path
            d="M17.47 14.38c-.3-.15-1.76-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.94 1.17-.17.2-.35.22-.64.07-.3-.15-1.26-.46-2.4-1.48-.89-.79-1.49-1.77-1.66-2.07-.17-.3-.02-.46.13-.61.14-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.03-.52-.07-.15-.67-1.61-.92-2.21-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.07-.79.37-.27.3-1.04 1.01-1.04 2.47s1.06 2.86 1.21 3.06c.15.2 2.09 3.19 5.06 4.47.71.3 1.26.49 1.69.63.71.22 1.36.19 1.87.12.57-.09 1.76-.72 2.01-1.41.25-.7.25-1.29.17-1.41-.07-.13-.27-.2-.57-.35z"
            fill="white"
          />
        </svg>
      );
    case "TIKTOK":
      return (
        <svg className={className} viewBox="0 0 24 24" fill="none">
          ...
          <path
            d="M16.6 8.17a4.28 4.28 0 01-2.63-.9A4.28 4.28 0 0112.8 5h-2.17v9.72a2.14 2.14 0 01-2.14 2.14 2.14 2.14 0 01-2.14-2.14 2.14 2.14 0 012.14-2.14c.23 0 .44.04.65.1V10.5a4.32 4.32 0 00-.65-.05 4.32 4.32 0 00-4.32 4.32A4.32 4.32 0 008.49 19a4.32 4.32 0 004.32-4.32V10.3a6.44 6.44 0 003.8 1.23V9.36a4.28 4.28 0 01-1.17-.3V8.17h1.17z"
            fill="white"
          />
        </svg>
      );
