...
export function MessengerLogo({ className = "w-6 h-6" }: LogoProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="msg_grad" x1="50%" y1="0%" x2="50%" y2="100%">
          <stop offset="0%" stopColor="#00B2FF"/>
          <stop offset="100%" stopColor="#006AFF"/>
        </linearGradient>
      </defs>
      <path d="M12 2C6.477 2 2 6.145 2 11.243c0 2.893 1.436 5.474 3.682 7.158V22l3.39-1.862c.904.25 1.862.384 2.858.384h.07C17.523 20.522 22 16.376 22 11.243 22 6.145 17.523 2 12 2z" fill="url(#msg_grad)"/>
